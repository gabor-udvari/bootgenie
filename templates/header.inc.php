<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a href="<?php echo $link; ?>" class="navbar-brand">
                <?php echo image_tag(\thebuggenie\core\framework\Settings::getHeaderIconUrl(), [], \thebuggenie\core\framework\Settings::isUsingCustomHeaderIcon()); ?>
                <?php echo \thebuggenie\core\framework\Settings::getSiteHeaderName(); ?>
            </a>
        </div>
        <?php \thebuggenie\core\framework\Event::createNew('core', 'header_after_logo')->trigger(); ?>
