<?php
if (!isset($whatlinkshere)){
    // is whatlinkshere is not set create an empty array to avoid errors
    $whatlinkshere = [];
}
?>
<div class="panel panel-default toggled<?php if (count($whatlinkshere) == 0) echo ' visible'; ?>">
    <div class="panel-heading" onclick="if ($('nothing_links_here') == undefined) $(this).up().toggleClassName('visible');">
        <h3 class="panel-title"><?php echo __('Links to this article'); ?></h3>
    </div>
